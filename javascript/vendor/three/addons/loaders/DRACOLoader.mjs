...
const WASM_JS_URL = new URL( '../libs/draco/draco_wasm_wrapper.mjs', import.meta.url ).toString();
const JS_URL = new URL( '../libs/draco/draco_decoder.mjs', import.meta.url ).toString();

const DRACO_GLTF_CONFIG = {
	js: new URL( '../libs/draco/gltf/draco_wasm_wrapper.mjs', import.meta.url ).toString(),
...
class DRACOLoader extends Loader {
	...
	setDecoderPath( path ) {
		...
		if ( typeof path === 'object' ) {
			...
			decoderPaths.js = LoaderUtils.resolveURL( 'draco_wasm_wrapper.mjs', path );
			decoderPaths.wasm = LoaderUtils.resolveURL( 'draco_decoder.wasm', path );
			decoderPaths.dep_js = LoaderUtils.resolveURL( 'draco_decoder.mjs', path );
