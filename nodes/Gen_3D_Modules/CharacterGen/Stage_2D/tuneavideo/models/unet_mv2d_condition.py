...
class UNetMV2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def from_pretrained_2d(
        ...
        # what raised TypeError here. Everything CharacterGen pulls is a
        # public repo, so rather than rename it we stop threading a
        # credential through at all; the pop stays so an old caller passing
        # it is ignored rather than landing in **kwargs.
